...
function OpenCloakroomMenu()
	...
	elseif grade == 'captain' then
        ...
        elseif grade == 'assistant_chief' then
		table.insert(elements, {label = _U('police_wear'), value = 'assistant_chief_wear'}) 
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		if
			...
			data.current.value == 'captain_wear' or
                        ...
                        data.current.value == 'assistant_chief_wear' or
		...
		elseif data.current.value == 'object_spawner' then
			...
			'default', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				elements = {
					...
					{label = _U('spikestrips'),	value = 'p_stinger_04'},
